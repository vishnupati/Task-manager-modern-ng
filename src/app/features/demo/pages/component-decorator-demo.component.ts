      ...
      fields: [
        {
          ...
          example: "selector: 'app-my-component'",
        },
        {
          name: 'template/templateUrl',
          description: 'Component HTML content',
          example: "templateUrl: './my.component.html'",
        },
      ],
    },
    {
      ...
      fields: [
        {
          name: 'imports',
          description: 'Import other standalone components, directives',
          example: 'imports: [CommonModule, MyComponent]',
        },
        {
          name: 'providers',
          description: 'Services to inject (component-level DI)',
          example: 'providers: [UserService, AuthService]',
        },
        {
          name: 'styles/styleUrls',
          description: 'CSS styling for component',
          example: "styleUrl: './my.component.scss'",
        },
        {
          name: 'standalone',
          description: 'Mark component as standalone (Angular 14+)',
      ...
      fields: [
        {
          ...
          description: 'Control change detection strategy',
          example: 'changeDetection: ChangeDetectionStrategy.OnPush',
        },
        {
          name: 'encapsulation',
          description: 'CSS scope: Emulated, None, or ShadowDom',
          example: 'encapsulation: ViewEncapsulation.ShadowDom',
        },
      ],
    },
    {
      ...
      fields: [
        {
          name: 'host',
          description: 'Bind to host element properties & events',
          example: "host: { 'class': 'my-class', '(click)': 'onClick()' }",
        },
        {
          name: '@HostBinding',
          description: 'Decorator to bind properties to host',
          example: "@HostBinding('class.active') isActive = true;",
        },
        {
          name: '@HostListener',
          description: 'Decorator to listen to host events',
          example: "@HostListener('click') onClick() {}",
        },
      ],
    },
    {
      ...
      fields: [
        {
          name: 'viewProviders',
          description: 'Providers visible to child components only',
          example: 'viewProviders: [SomeService]',
        },
        {
          name: 'animations',
          description: 'Define component animations',
          example: "animations: [trigger('fadeIn', [...])]",
        },
        {
          name: 'schemas',
          description: 'Allow unknown elements/attributes',
          example: 'schemas: [NO_ERRORS_SCHEMA]',
        },
      ],
    },
    {
      ...
      fields: [
        {
          name: 'interpolation',
          description: 'Change template interpolation syntax',
          example: "interpolation: ['{%', '%}']",
        },
        {
          name: 'preserveWhitespace',
          description: 'Preserve whitespace in template',
          example: 'preserveWhitespace: true',
        },
      ],
    },
  ]);
